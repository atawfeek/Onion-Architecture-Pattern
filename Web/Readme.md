...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *MLS.WebAPIs*):
...
Execute unit tests
```
    cd "MLS.WebAPIs/test/MLS.WebAPIs.Tests"
    dotnet test
```

Deploy application
```
    cd "MLS.WebAPIs/src/MLS.WebAPIs"
